<template>
  <el-menu  :default-active="$route.path" mode="horizontal"
            background-color="#4DB3B3" text-color="#000" active-text-color="#fff">
    <template v-for="item in permission_routers" v-if="item.meta&&!item.meta.hidden">
    ...
    <!--<navi-menu-item :routes="permission_routers"></navi-menu-item>-->
  </el-menu>
</template>
