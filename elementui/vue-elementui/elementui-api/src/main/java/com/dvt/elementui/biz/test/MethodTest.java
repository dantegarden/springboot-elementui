...
public class MethodTest {
    ...
    public void say() {
        ...
        for(int i=0;i<120;i++){
            //String sql = "INSERT INTO `demo_customer` VALUES (null, '"+getCustomerName()+ "', '"+ (random.nextInt(2)+1) +"', '"+getRoad()+"', sysdate());";
            String customerId = (random.nextInt(120)+10001)+"";
            String orderSn = getOrderSn();
            String orderStatus = random.nextInt(4)+1 +"";
            String sql = "INSERT INTO `demo_order` VALUES (null, '"+ customerId +"', 'OSN"+orderSn+"','"+orderStatus+"', '3799', '黑色 64G',sysdate(), sysdate());";
            System.out.println(sql);

            String sq2 = "INSERT INTO `demo_order_goods` VALUES (null,"+(10002 + i)+", "+(random.nextInt(3)+10000)+", sysdate());";
